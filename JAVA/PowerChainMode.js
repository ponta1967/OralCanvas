...
class PowerChainMode {
    ...
    activate(pcType) {
        console.log('Activating PowerChain mode:', pcType);
        this.isActive = true;
        this.currentPCType = pcType;
        this.points = [];
        this.lastPoint = null;
    ...
    deactivate() {
        if (this.isActive) {
            console.log('Deactivating PowerChain mode');
            this.isActive = false;
    ...
    drawText(x, y) {
        ...
        this.ctx.fillText(`PC${this.currentPCType}`, x, y - 5);
    }
    ...
    getColor() {
        switch (this.currentPCType) {
            case '橙': return 'rgb(226, 108, 0)';
            case '桃': return 'rgb(255, 138, 195)';
            case '青': return 'rgb(15, 88, 228)';
            case '黄': return 'rgb(255, 213, 0)';
            case '緑': return 'rgb(20, 167, 49)';
            case '茶': return 'rgb(122, 47, 4)';
